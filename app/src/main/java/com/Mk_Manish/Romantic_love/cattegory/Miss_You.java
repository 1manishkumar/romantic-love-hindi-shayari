...
public class Miss_You extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.miss_you);


        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Miss You");
        ...
        DatabaseReference dataref =firebaseDatabase.getReference("miss_you");
