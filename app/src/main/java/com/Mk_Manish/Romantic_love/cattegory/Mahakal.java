...
public class Mahakal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mahakal);


        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Mahakal");
        ...
        mAdView.loadAd(adRequest);
            ...
            DatabaseReference dataref =firebaseDatabase.getReference("mahakal");
